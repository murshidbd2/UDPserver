...
idioam_lang(){
  source <(curl -sSl 'https://raw.githubusercontent.com/murshidbd2/UDPserver/main/lang/lang')
  ...
  for arch in $listarq; do
    if ! wget -O $lang_dir/${list_lang[$lg]}/$arch "https://raw.githubusercontent.com/murshidbd2/UDPserver/main/lang/lang/${list_lang[$lg]}/$arch" &>/dev/null ;then
